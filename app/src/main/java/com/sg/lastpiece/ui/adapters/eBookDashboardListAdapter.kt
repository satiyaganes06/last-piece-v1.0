...
open class eBookDashboardListAdapter(
        private val context: Context,
        private var list: ArrayList<eBook_Details>
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
            return MyViewHolder(
                LayoutInflater.from(context).inflate(
                    R.layout.book_list_ebook_dashboard,
                    parent,
                    false
                )
            )
        ...
        override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
            ...
            if (holder is MyViewHolder) {
                ...
                holder.itemView.tv_dashboard_item_title.text = model.ebook_name
                holder.itemView.tv_book_condition.text = model.ebook_category
        ...
        interface OnClickListener {
            ...
            fun onClick(position: Int, ebook : eBook_Details)
        }
